...
Use the Copilot bridge path: `lib/mcp.copilot.status.ps1`, `lib/repl-invoke.ps1`, `lib/marker-resolver.ps1`, and `lib/final-response.ps1`. Do not use raw REST for normal MCP mutations.
